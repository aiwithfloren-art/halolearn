...
function CVAnalyzerContent() {
  ...
  const paymentLink = `https://wa.me/6285260421274?text=${encodeURIComponent(`Halo, saya ${session?.user?.name} ingin analisa CV lengkap. Email: ${session?.user?.email}`)}`;
          ...
          <>
            ...
            <div className="mb-12">
              ...
              <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 px-8 py-12 text-center text-white shadow-lg">
                <h3 className="mb-4 text-2xl font-bold">Upgrade CV Profile-mu Dengan Ahli</h3>
                <p className="mb-6 text-slate-300">
                  Tim kami akan handle semua revisi dan optimization untuk hasil maksimal
                </p>
                <a
                  href={paymentLink}
                  target="_blank"
