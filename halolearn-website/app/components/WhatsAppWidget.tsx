    ...
    <>
      ...
      {showBubble && !isOpen && (
        <div className="fixed bottom-24 right-6 animate-slide-up z-40">
          <div className="bg-white rounded-2xl shadow-lg p-4 max-w-xs border border-slate-200">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="w-14 h-14 bg-green-600 rounded-full shadow-lg hover:shadow-xl transition flex items-center justify-center text-white text-2xl animate-pulse-button"
