...
const digitalProducts: DigitalProduct[] = [
  {
    ...
    tagline: '14 hari siap psikotes + interview panel BNI ODP',
    description: 'Playbook 59 halaman — 45+ sample answers, section psikotes deep dive 7 halaman (20+ sample Papikostik + Kraepelin + Wartegg), banking primer. Berdasarkan real case D.A. yang diterima BNI ODP Retail Banking 2026.',
    price: 'Rp135.000',
    features: [
      'PDF 59 halaman — instant delivery via WhatsApp',
      'Section Psikotes Prep 7 halaman — 20+ sample Papikostik, Kraepelin daily practice, Wartegg 8 kotak + scoring rubric insider',
      ...
      'Day-of checklist + follow-up email template + Glossary 60+ istilah banking',
    ],
    fileSize: '141 KB',
    pages: 59,
  },
